...
{
    public class ChangeTaskEmployee : ITaskOption
    {
        ...
        public void Option()
        {
            ...
            var request = HttpWebRequest.Create($"https://localhost:5001/tasks/employee?id={id}&employeeId={employeeId}");
            ...
            try
            {
                ...
                Console.WriteLine("Task with new employee:");
